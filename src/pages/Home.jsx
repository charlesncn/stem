    ...
    <div className="home">
      <div className="container">
        ...
        <div className="right">
          ...
          <span className="dates">Starting 26<sup>th</sup> & 27<sup>th</sup> November <br/> (onwards)</span>
          <br />
      ...
      <div className="activities">
        ...
        <div className="card">
          <span>Zumba</span>
          <img
            src="https://github.com/charlesncn/stem/blob/main/src/imgs/zumba.png?raw=true"
            className="gameName" alt=""
          />
